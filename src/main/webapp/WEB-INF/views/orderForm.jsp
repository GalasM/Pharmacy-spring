...
<form method="post" action="${contextPath}/createorder">
    <table>
        <tr>
            <td>
                <label>Nazwa leku
                <select id="product" name="product">
                    ...
                    <option value="${product.id}" <c:if test="${id == product.id}"> selected=</c:if> >${product.name}</option>
                    </c:forEach>
                </select>
                </label>
            </td>
        ...
        <tr>
            <td>
                <button type="submit" class="btn btn-dark">Złóż zamówienie</button>
            </td>
        </tr>
    </table>
