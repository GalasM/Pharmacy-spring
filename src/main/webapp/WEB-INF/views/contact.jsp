...
<nav class="navbar navbar-dark navbar-toggler-right">
    <div class="container">
        ...
        <a class="nav-link scroll-link active" href="${contextPath}/contact">Kontakt</a>
...
<form method="post" action="sendMail" class="center">
    <div class="form-group">
        <input class="form-control" type="text" id="email" name="email" placeholder="Twoj email.."><br>
    </div>
    <div class="form-group">
        <input class="form-control" type="text" id="topic" name="topic" placeholder="Twoj temat.."><br>
    </div>
    <br/>
    <div class="form-group">
        <textarea class="form-control" id="content" name="content" placeholder="Tresc.." style="height:200px"></textarea><br>
    </div>
    <br/>

    <input class="btn btn-primary" type="submit" value="Wyslij wiadomosc">
</form>
