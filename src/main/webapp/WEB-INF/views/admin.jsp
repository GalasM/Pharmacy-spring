                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <c:if test="${isAdmin}">
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" href="${contextPath}/adminprofile">Panel administratora</a>
                        </li>
                    </c:if>
                    <li class="nav-item">
...
<div>
    <br /><br />
    <p><a class="btn btn-outline-warning btn-sm" href="${contextPath}/products">Produkty</a></p>
    <p><a class="btn btn-outline-warning btn-sm" href="${contextPath}/productform">Dodaj produkty</a></p>
    <p><a class="btn btn-outline-warning btn-sm" href="${contextPath}/users">Użytkownicy</a></p>
</div>
